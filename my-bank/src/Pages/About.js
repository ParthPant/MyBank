    ...
    <div>
      ...
      <div className="card card-side glass image-full m-10 flex h-[79.5vh]">
        ...
        <div className="card-body items-center text-center m-auto">
          ...
          <h2 className="font-helvetica text-xl text-justify">Want a one-stop solution to manage your customer database?
          MyBank is the website you're looking for. With this application, you can add, remove, and edit your
          customers' details with just the click of a button. Log in now for a seamless administration experience.</h2>
        </div>
      </div>
    </div>
  );
