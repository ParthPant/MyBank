...
function ViewAccount() {
    ...
    React.useEffect(() => {
        axios.get(baseURL + "customers/" + id + "/accounts", {
            params: {
    ...
    var deleteAcc = (accNo) =>{
        axios.delete(baseURL + "customers/" + id + "/accounts/" + accNo, {
    ...
    return (
        <>
            ...
            <div class="pt-10 pb-10 glass">
                ...
                <button className="btn btn-primary bg-purple-600 rounded-none hover:cursor-pointer">Transactions</button>
              </Link>
                                            </tr>
                                        );
